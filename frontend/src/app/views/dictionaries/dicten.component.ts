...
import { Language } from '../terminology/language';
import { LanguageService } from '../terminology/shared/services/language.service';
...
export class DictenComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.cols = [
      ...
      { field: 'name', header: 'Language', editable: true },
